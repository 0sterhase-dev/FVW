const translations = {
  de: {
    brand: 'Ferienhaus Valentin',
    brandSub: 'Oberammergau · Bayern',
    ...
    ratingLabel: 'auf Airbnb',
    hostVerified: 'Verifizierter Airbnb-Gastgeber Thomas',
    statGuests: 'Personen',
    statGuestsValue: '6',
    statRooms: 'Schlafzimmer',
    statRoomsValue: '3',
    statBathrooms: 'Bäder',
    ...
    feature2Text: 'Ein Kamin-Feeling und natürliche Farben schaffen eine ruhige, stilvolle Urlaubsstimmung.',
    feature3Title: 'Blick auf die Berge',
    feature3Text: 'Die Lage nahe der Alpen macht das Haus zum idealen Ausgangspunkt für Naturerlebnisse und Ausflüge.',
    amenitiesEyebrow: 'Ausstattung',
    amenitiesTitle: 'Alles drin, was man im Urlaub wirklich braucht.',
    ...
    gallery4Text: 'Frische Luft, Ruhe und der perfekte Platz für den Morgenkaffee.',
    ...
    review1: 'Eine sehr schöne Unterkunft und top ausgestattet. Kann ich nur empfehlen!',
    review2: 'Unser zweites Mal in diesem wunderbaren Haus. Wir werden wiederkommen. Es ist eine perfekte Unterkunft.',
    review3: 'Die Unterkunft hatte alles, was wir brauchten, und mehr. Wir haben uns wie zuhause gefühlt.',
    locationEyebrow: 'Lage',
    locationTitle: 'Oberammergau – ruhig, charmant und nah an München.',
    locationText: 'Das Ferienhaus liegt in einer der schönsten Regionen Bayerns. Von hier aus erreichst du die Ammergauer Alpen, Garmisch-Partenkirchen, den Eibsee und München in bequemer Fahrzeit.',
    location1: '🏔️ Alpen & Wanderwege',
    location2: '🏰 Ausflüge zu Schlössern',
    location3: '🚆 Gute Anbindung Richtung München',
  ...
  en: {
    brand: 'Holiday Home Valentin',
    brandSub: 'Oberammergau · Bavaria',
    navAbout: 'About',
    ...
    ratingLabel: 'on Airbnb',
    hostVerified: 'Verified Airbnb host Thomas',
    statGuests: 'guests',
    statGuestsValue: '6',
    statRooms: 'bedrooms',
    statRoomsValue: '3',
    ...
    feature2Text: 'A fireplace feel and natural colors create a calm, stylish holiday mood.',
    feature3Title: 'Mountain views',
    feature3Text: 'Its location near the Alps makes the house the perfect starting point for outdoor adventures and day trips.',
    amenitiesEyebrow: 'Amenities',
    amenitiesTitle: 'Everything you actually need on vacation.',
    amenity1: 'Free Wi‑Fi',
    ...
    gallery4Text: 'Fresh air, calm, and the perfect morning coffee spot.',
    ...
    gallery8Title: 'Lounge',
    gallery8Text: 'Soft light, plenty of room, and a contemporary look.',
    reviewsEyebrow: 'Reviews',
    reviewsTitle: '5.0 stars on Airbnb and strong guest feedback.',
    reviewSummaryText: 'Clean, quiet, and equipped with three bedrooms plus 4.5 bathrooms for a relaxed stay.',
    review1: 'A very beautiful place and top equipped. Highly recommended!',
    review2: 'Our second time in this wonderful house. We will come back. It is a perfect place.',
    review3: 'The accommodation had everything we needed and more. We felt right at home.',
    locationEyebrow: 'Location',
    locationTitle: 'Oberammergau — calm, charming, and close to Munich.',
    locationText: 'The holiday home is set in one of Bavaria’s most beautiful regions. From here you can reach the Ammergau Alps, Garmisch-Partenkirchen, Lake Eibsee, and Munich in a comfortable drive.',
    location1: '🏔️ Alps & hiking trails',
    location2: '🏰 Castle day trips',
    location3: '🚆 Easy access toward Munich',
...
const detectedLocale = (() => {
  const lang = (navigator.languages && navigator.languages.length ? navigator.languages[0] : navigator.language || 'de').toLowerCase();
  return lang.startsWith('de') ? 'de' : 'en';
})();

const copy = translations[detectedLocale];

document.documentElement.lang = detectedLocale;
document.title = detectedLocale === 'de'
  ? 'Ferienhaus Valentin | Oberammergau bei München'
  : 'Holiday Home Valentin | Oberammergau near Munich';
...
if (metaDescription) {
  metaDescription.setAttribute(
    'content',
    detectedLocale === 'de'
      ? 'Ferienhaus in Oberammergau bei München mit Bergblick, Terrasse, 5,0 Airbnb-Sterne, Buchungslink, Bewertungen und direktem Kontakt.'
      : 'Holiday home in Oberammergau near Munich with mountain views, terrace, 5.0 Airbnb stars, booking link, reviews, and direct contact.'
  );
}
